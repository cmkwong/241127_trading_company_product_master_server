...
const CERTIFICATE_TYPES_TABLE =
  PRODUCT_TABLE_MASTER['MASTER_CERTIFICATE_TYPES'].name;
const PRODUCT_CERTIFICATES_TABLE =
  PRODUCT_TABLE_MASTER['PRODUCT_CERTIFICATES'].name;
