...
export const SALES_QUOTATIONS_TABLE_DEFINITIONS = {
  SALES_QUOTATIONS: {
    ...
    fields: {
      ...
      assigned_picker: {
        type: 'VARCHAR(255)',
        description: 'Reference to users.id for the assigned picker',
      },
      assigned_picker_address: {
        type: 'TEXT',
        description: 'Address of the assigned picker',
      },
      posting_at: {
        type: 'TIMESTAMP',
  ...
  SALES_PACKING_ITEMS: {
    name: 'sales_packing_items',
    table_type: 'sales-data',
    description: 'Items included in the sales packing list',
    fields: {
      id: {
        type: 'VARCHAR(36)',
        primaryKey: true,
  ...
  SALES_PACKING_ITEM_IMAGES: {
    name: 'sales_packing_item_images',
    table_type: 'sales-data',
    description: 'Images associated with sales packing items',
    fields: {
      id: {
        type: 'VARCHAR(36)',
        primaryKey: true,
  ...
  SALES_PACKING_ITEM_INTERNAL_IMAGES: {
    name: 'sales_packing_item_internal_images',
    table_type: 'sales-data',
    fields: {
      id: {
        type: 'VARCHAR(36)',
  ...
  SALES_PACKING_ITEM_INTERNAL_FILES: {
    name: 'sales_packing_item_internal_files',
    table_type: 'sales-data',
    fields: {
      id: {
        type: 'VARCHAR(36)',
